...
public class OOBEConst {
	public final static String[] ACTIVITY_NAME =  new String[] {
			"KeyActivity", "BitmapActivity", "StartActivity",
			"ReceiveActivity", "PaletteActivity", "AnimationActivity",
