...
import com.funnyplayer.GlobeApp;
...
public class AppHttpClient extends DefaultHttpClient {
	...
	private static AppHttpClient mInstance = new AppHttpClient();
	
	public static AppHttpClient getSingleInstance() {
		return mInstance;
	}
	...
	protected SocketFactory getHttpsSocketFactory() {
		try {
			...
			Object sslSessionCache = sslSessionCacheClass.getConstructor(Context.class).newInstance(GlobeApp.AppContext);
